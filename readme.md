# Plex Music Grabber
Plex Music Grabber is a tool that monitors your Plex TV Show library for missic theme music. Unfortunately not all shows on Plex have theme songs, so I wrote this small app that automatically downloads theme songs
...
-v /path/to/my/tv/show/library:/library \
-e interval=3600 \
